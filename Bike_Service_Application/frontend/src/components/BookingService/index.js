            ...
            {value => {        
                ...
                const handleBookService = async event => {
                    ...
                    if (userData.userSelectedServices.length > 0){
                        ...
                        try {
                            const response = await fetch('http://localhost:5000/api/booking-service', {
                                method: 'POST',
                                headers: {
...
//                 {serviceData.map(eachService => (
//                   <li
//                     className={eachService.serviceCheckBox ? 'checked-style' : 'check-item-container'}
//                     key={eachService.id}
//                   >
//                     <label className='service-name-item' htmlFor={eachService.name}>
//                       <img src={eachService.imageUrl} alt={eachService.name} />
//                       <h4>{eachService.name}</h4>
//                     </label>
//                     <input
...
//             <div className='err-con'>
//               {resultStatus === true && <h4 className='booking-success-msg'>Booking Successfully</h4>}
//               {resultStatus === false && <h4 className='booking-err-msg'>*Please choose your services</h4>}
//             </div>
